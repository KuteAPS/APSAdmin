...
{
	/// <summary>
	/// Strongly-typed collection for the TBasisWebGroup class.
	/// </summary>
    [Serializable]
	public partial class TBasisWebGroupCollection : ActiveList<TBasisWebGroup, TBasisWebGroupCollection>
	{	   
		public TBasisWebGroupCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>TBasisWebGroupCollection</returns>
		public TBasisWebGroupCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                TBasisWebGroup o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the T_Basis_WebGroup table.
	/// </summary>
	[Serializable]
	public partial class TBasisWebGroup : ActiveRecord<TBasisWebGroup>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public TBasisWebGroup()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public TBasisWebGroup(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public TBasisWebGroup(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public TBasisWebGroup(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("T_Basis_WebGroup", TableType.Table, DataService.GetInstance("Nowthwin"));
				...
				colvarGroupIcon.DefaultSetting = @"";
				colvarGroupIcon.ForeignKeyTableName = "";
				...
				DataService.Providers["Nowthwin"].AddSchema("T_Basis_WebGroup",schema);
			}
		}
		#endregion
		...
		{
			get { return GetColumnValue<string>(Columns.GroupIcon); }
			set { SetColumnValue(Columns.GroupIcon, value); }
		}
		...
		/// </summary>
		public static void Insert(string varGroupName,string varGroupIcon,int? varSort)
		{
			TBasisWebGroup item = new TBasisWebGroup();
			
			item.GroupName = varGroupName;
			
			item.GroupIcon = varGroupIcon;
		...
		/// </summary>
		public static void Update(int varId,string varGroupName,string varGroupIcon,int? varSort)
		{
			TBasisWebGroup item = new TBasisWebGroup();
        ...
        public static TableSchema.TableColumn GroupIconColumn
        {
