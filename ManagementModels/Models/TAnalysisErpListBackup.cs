...
{
	/// <summary>
	/// Strongly-typed collection for the TAnalysisErpListBackup class.
	/// </summary>
    [Serializable]
	public partial class TAnalysisErpListBackupCollection : ActiveList<TAnalysisErpListBackup, TAnalysisErpListBackupCollection>
	{	   
		public TAnalysisErpListBackupCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>TAnalysisErpListBackupCollection</returns>
		public TAnalysisErpListBackupCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                TAnalysisErpListBackup o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the T_Analysis_ErpListBackup table.
	/// </summary>
	[Serializable]
	public partial class TAnalysisErpListBackup : ActiveRecord<TAnalysisErpListBackup>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public TAnalysisErpListBackup()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public TAnalysisErpListBackup(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public TAnalysisErpListBackup(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public TAnalysisErpListBackup(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("T_Analysis_ErpListBackup", TableType.Table, DataService.GetInstance("Nowthwin"));
				...
				DataService.Providers["Nowthwin"].AddSchema("T_Analysis_ErpListBackup",schema);
			}
		}
		#endregion
