...
namespace Models{
    /// <summary>
    /// Strongly-typed collection for the VCadOrderlistMtm class.
    /// </summary>
    [Serializable]
    public partial class VCadOrderlistMtmCollection : ReadOnlyList<VCadOrderlistMtm, VCadOrderlistMtmCollection>
    {        
        public VCadOrderlistMtmCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the V_CAD_ORDERLIST_MTM view.
    /// </summary>
    [Serializable]
    public partial class VCadOrderlistMtm : ReadOnlyRecord<VCadOrderlistMtm>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("V_CAD_ORDERLIST_MTM", TableType.View, DataService.GetInstance("Nowthwin"));
                ...
                DataService.Providers["Nowthwin"].AddSchema("V_CAD_ORDERLIST_MTM",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public VCadOrderlistMtm()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public VCadOrderlistMtm(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public VCadOrderlistMtm(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public VCadOrderlistMtm(string columnName, object columnValue)
        {
            SetSQLProps();
