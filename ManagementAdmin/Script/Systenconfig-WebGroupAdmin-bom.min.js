...
! function (e, t, o) {
    ...
    ! function () {
        var PageTable = o("#TableAdmin").bootstrapTable({
            url: '/SystemConfig/GetAllWebPageGroups',         //请求后台的URL（*）
            method: 'get',
            //search: !0,
            pagination: !0,
            showRefresh: !0,
    ...
    $("#btn_Del").click(function () {
        PostData(TableAdmin, "/SystemConfig/DelWebPageGroups", o, "#TableAdmin");
    });
    ...
    $("#btn_Edit").click(function () {
        ...
        $("#groupIcon").val(json[0].GroupIcon);
    ...
    $("#btn_submit").click(function (e) {
        ...
        $.post("/SystemConfig/AddOrUpdateWebPageGroup", $("#signupForm").serialize(), function (data) {
            layer.close(msg);
